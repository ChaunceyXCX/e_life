...
* @{
*/
#define PRODUCT_KEY "6a47f3da99874d39ad67b68aeb60498b"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "40657e61fbf44a939d76e01cec230adb"
...
* @{
*/
#define LiteSwitch_BYTEOFFSET                    0
#define LiteSwitch_BITOFFSET                     0
#define LiteSwitch_LEN                           1
#define Gate_BYTEOFFSET                    0
#define Gate_BITOFFSET                     1
#define Gate_LEN                           2
#define GateSta_BYTEOFFSET                    1
#define GateSta_BITOFFSET                     0
#define GateSta_LEN                           1
